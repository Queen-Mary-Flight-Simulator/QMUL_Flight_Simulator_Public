...
extern int FCU_BaroKnob_State;           /* >0 temporarily pulled, <0 temporarily pushed =0 normal */
extern int FCU_SPDKnob_State;
extern int FCU_HDGKnob_State;
extern int FCU_ALTKnob_State;
extern int FCU_VSKnob_State;
