...
int FCU_BaroKnob_State;     /* >0 pulled, <0 pushed =0 middle */
int FCU_HDGKnob_State;
int FCU_ALTKnob_State;
int FCU_SPDKnob_State;
int FCU_VSKnob_State;
...
*/
                    ...
                    switch (i)
                    {
                        case 0:
                            ...
                            if (FCU_BaroHg)
                            {
								...
								FCU_BaroKnob_State = -250;
                            }
                            else
                            {
                                FCU_BaroPressure = 1013;
								FCU_BaroKnob_State = 0;
                            }
                            break;
                        case 1:
    ...
    PanelLib_DisplayFCU(PushSwitchList[SwFD],
                        ...
                        NavSelector,
                        RangeSelector,
                        KnobAngle[0], KnobAngle[1], KnobAngle[2], KnobAngle[3], KnobAngle[4],
                        &FCU_BaroKnob_State, &FCU_SPDKnob_State, &FCU_HDGKnob_State, &FCU_ALTKnob_State, &FCU_VSKnob_State,
                        FCU_BaroHg,
						Alt000);
