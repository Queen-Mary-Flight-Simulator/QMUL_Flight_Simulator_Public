...
Vertex SwitchCoords[14] =  /* N.B. these offsets should match PanelLib_DisplayRadio() */
{
    {                0,                0 },
...
#define KnobX          (NFD_RadioX + 451)
#define KnobY          (NFD_RadioY + 169)
...
void Radio_UpdateRMP(int n, int leftb, int middleb, int rightb, int x, int y)
{
    ...
    if (leftb)
    {
	    bool leftinner  = (x > KnobX - 25) && (x < KnobX - 10) &&
                          (y > KnobY - 20) && (y < KnobY + 20);
		bool rightinner = (x < KnobX + 25) && (x > KnobX + 10) &&
                          (y > KnobY - 20) && (y < KnobY + 20);
		bool leftouter  = (x > KnobX - 50) && (x < KnobX - 30) &&
                          (y > KnobY - 20) && (y < KnobY + 20);
		bool rightouter = (x < KnobX + 50) && (x > KnobX + 30) &&
                          (y > KnobY - 20) && (y < KnobY + 20);
