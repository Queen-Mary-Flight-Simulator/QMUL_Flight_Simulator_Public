...
void ScriptUpdate(char Filename[])
{
    ...
    while (1)
    {
        if (IOLib_GetHoldButton(IosLink_IOPkt1) || Script_Enabled == false)
        {
            return;
        }
        ...
        case i_PUSHV:
            ...
            case 24:
                ...
                break;
            case 25:
                StackPush(IOLib_GetElevator(IosLink_IOPkt1));
                break;
            case 26:
                StackPush(IOLib_GetAileron(IosLink_IOPkt1));
                break;
            case 27:
                StackPush(IOLib_GetRudder(IosLink_IOPkt1));
                break;
            case 28:
            ...
            case 30:
                ...
                break;
            case 31:
                StackPush(IOLib_GetLeftBrake(IosLink_IOPkt1));
                break;
            case 32:
                StackPush(IOLib_GetRightBrake(IosLink_IOPkt1));
                break;
            case 33:
