...
void LoadRestoreFile(char Filename[])
{
    ...
    IosPkt.RestoreVector.SavedRadios[0].NavVOR.Active = 11400;
    IosPkt.RestoreVector.SavedRadios[0].NavILS.Active = 11090;
    IosPkt.RestoreVector.SavedRadios[0].NavADF.Active = 3650;
...
void ModifyAndWriteRestoreFile(IosDefn_RestoreVectorRecord *a)
{
	...
	// Sheffield Threshold
	//a->Latitude = Radians(53.39381);
	//a->Longitude = Radians(-1.37948);
	
	// M1 J29 Centre (Nr Chesterfield)
	a->Latitude = Radians(53.197665);
	a->Longitude = Radians(-1.32285);
	a->Pitch = 0.0;
	a->Roll = 0.0;
