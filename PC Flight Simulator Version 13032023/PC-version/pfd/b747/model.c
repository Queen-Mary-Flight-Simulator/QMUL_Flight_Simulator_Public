...
void Model_FlightModel()
{
    ...
    Model_ElevatorTrim = Systems_GetElevatorTrim();
    Model_AileronTrim  = Systems_GetAileronTrim();
    Model_RudderTrim   = Systems_GetRudderTrim();
	...
	//printf("lat=%f long=%f yaw=%f\n", Model_Latitude*(180/3.14159265), Model_Longitude*(180/3.14159265), Model_Yaw*(180/3.14159265));
