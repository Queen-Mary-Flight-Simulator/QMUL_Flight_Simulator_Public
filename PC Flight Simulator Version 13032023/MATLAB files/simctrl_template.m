%{
    Flight Simulator - MATLAB interface M-FILE script template
	
	Please make a backup copy of this script. This script contains the necessary code
	to establish a connection and remain synchronised with the flight simulator.
