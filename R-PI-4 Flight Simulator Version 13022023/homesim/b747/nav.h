...
typedef struct 
{
    ...
    float LocaliserError;        /* radians */
    float GlideSlopeError;       /* radians */
    float SlantDistance;         /* m */
    float BearingToStation;      /* radians */
    bool  BeaconStatus;          /* true if active */
    bool  IlsFrequency;          /* true if ILS */
    float RunwayQdm;             /* QDM (T) radians */
} Nav_NavRecord;
