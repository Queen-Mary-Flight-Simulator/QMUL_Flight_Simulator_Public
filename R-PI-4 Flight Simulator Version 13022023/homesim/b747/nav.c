...
//printf("cr=%d OTG=%c Pz=%f dist=%f\n", Nav_CurrentRunway, (NavLink_AeroPkt.OnTheGround) ? 'T' : 'F', NavLink_AeroPkt.Pz,
//NavLib_Distance(NavLink_AeroPkt.Latitude, NavLink_AeroPkt.Longitude, NavLib_Runways[Nav_CurrentRunway].RunwayEndLatitude, NavLib_Runways[Nav_CurrentRunway].RunwayEndLongitude)); // ***
//    if (!NavLink_AeroPkt.OnTheGround && (NavLib_Distance(NavLink_AeroPkt.Latitude, NavLink_AeroPkt.Longitude, 
//                                                         NavLib_Runways[Nav_CurrentRunway].RunwayEndLatitude, NavLib_Runways[Nav_CurrentRunway].RunwayEndLongitude) > 3000.0)) // ***
    if (Nav_CurrentRunway == 0 || (NavLib_Distance(NavLink_AeroPkt.Latitude, NavLink_AeroPkt.Longitude, 
                         NavLib_Runways[Nav_CurrentRunway].RunwayEndLatitude, NavLib_Runways[Nav_CurrentRunway].RunwayEndLongitude) > 3000.0)) // ***
    {
