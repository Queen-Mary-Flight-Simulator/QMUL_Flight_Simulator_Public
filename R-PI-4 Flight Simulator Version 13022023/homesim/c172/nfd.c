...
void NFD_Display()
{
    ...
    Vor_Vor(NFD_VorX, NFD_VorY, Nav_VOR1.LocaliserError, Nav_VOR1.GlideSlopeError, Knobs_Obs, Nav_VOR1.IlsFrequency, Nav_VOR1.BeaconStatus,
            TEX_VOR_STATIC,
            TEX_VOR_COMPASS,
            TEX_KNOB_OBS);

    Adf_Adf(NFD_AdfX, NFD_AdfY, NavLink_AeroPkt.Yaw - (float) (Nav_MagneticVariation), Nav_ADF1.RmiPointer,
            TEX_COMPASS_STATIC,  /* includes screws! */
            TEX_VOR_COMPASS);
    ...
    Radio_Radio(NFD_RadioX, NFD_RadioY, TEX_RADIOSTACK, TEX_RADIOKNOB_SIMPLE, TEX_RADIOKNOB_OUTER, TEX_RADIOKNOB_INNER);
