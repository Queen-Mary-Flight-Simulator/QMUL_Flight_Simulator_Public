...
#define PFD_AoAX      (PFD_TurnSlipX + 90)
#define PFD_AoAY      (PFD_CompassY - 300)
#define PFD_GMeterX   (PFD_CompassX + 30)
#define PFD_GMeterY   PFD_AoAY
#define PFD_ClockX    (PFD_AiX - 476)
#define PFD_ClockY    PFD_GMeterY
#define PFD_RpmX      (PFD_CompassX + 32)
#define PFD_RpmY      (PFD_TurnSlipY - 300)
//#define PFD_BlankX    (PFD_RpmX - 270)
//#define PFD_BlankY    PFD_RpmY
...
#define PFD_EgtX      (PFD_RpmX - 270)
#define PFD_EgtY      PFD_RpmY
