...
void PFD_Display()
{
    ...
    Rpm_Rpm(PFD_RpmX, PFD_RpmY, AeroLink_EngPkt.Engines[0].Rpm, TEX_RPM, TEX_NEEDLE_ONE);
    Egt_Egt(PFD_EgtX, PFD_EgtY, AeroLink_EngPkt.Engines[0].Egt, TEX_EGT, TEX_NEEDLE_ONE);
