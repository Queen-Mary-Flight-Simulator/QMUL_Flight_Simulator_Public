...
void Gui_CheckMouse(void)
{
    ...
    if (leftkeypressed)
	{
	    if (Gui_MouseX > Glib_SCREENWIDTH - 50 && Gui_MouseY > Glib_SCREENHEIGHT - 50 &&
		    Gui_MouseX < Glib_SCREENWIDTH - 20 && Gui_MouseY < Glib_SCREENHEIGHT - 20)
		{
		    IOS_Mode = !IOS_Mode;
			OldMouseLeftButton = true;
			return;
		}
	}
