...
void DisplayVariable(char str1[], char str2[], float variable, int x, int y)
{
    ...
    Glib_Chars(v, x + 250 - Glib_StringSize(str2), y);
}
...
void DataView_Display(void)
{
    ...
    DisplayVariable("Pitch (deg)", " %10.2f", IosLink_AeroPkt.Pitch * ONERAD, X0 + 10, 710);
    DisplayVariable("Roll  (deg)", " %10.2f", IosLink_AeroPkt.Roll * ONERAD, X0 + 320, 710);
    DisplayVariable("Yaw   (deg)", " %10.2f", IosLink_AeroPkt.Yaw * ONERAD, X0 + 630, 710);
    DisplayVariable("P   (deg/s)", " %10.2f", IosLink_AeroPkt.P * ONERAD, X0 + 10, 680);
    DisplayVariable("Q   (deg/s)", " %10.2f", IosLink_AeroPkt.Q * ONERAD, X0 + 320, 680);
    DisplayVariable("R   (deg/s)", " %10.2f", IosLink_AeroPkt.R * ONERAD, X0 + 630, 680);
    DisplayVariable("Pdot (deg/s/s)", " %10.2f", IosLink_AeroPkt.PDot * ONERAD, X0 + 10, 650);
    DisplayVariable("Qdot (deg/s/s)", " %10.2f", IosLink_AeroPkt.QDot * ONERAD, X0 + 320, 650);
    DisplayVariable("Rdot (deg/s/s)", " %10.2f", IosLink_AeroPkt.RDot * ONERAD, X0 + 630, 650);
    ...
    DisplayVariable("Latitude (deg)", " %10.2f", IosLink_AeroPkt.Latitude * ONERAD, X0 + 320, 590);
    DisplayVariable("Longitude (deg)", " %10.2f", IosLink_AeroPkt.Longitude * ONERAD, X0 + 630, 590);
    ...
    DisplayVariable("Alpha (deg)", " %10.2f", IosLink_AeroPkt.Alpha * ONERAD, X0 + 10, 470);
    DisplayVariable("Alphadot (deg/s)", " %10.2f", IosLink_AeroPkt.AlphaDot * ONERAD, X0 + 320, 470);
    ...
    DisplayVariable("Elevator", " %10.2f", IosLink_AeroPkt.Elevator * ONERAD, X0 + 10, 260);
    DisplayVariable("Aileron", " %10.2f", IosLink_AeroPkt.Aileron * ONERAD, X0 + 320, 260);
    DisplayVariable("Rudder", " %10.2f", IosLink_AeroPkt.Rudder * ONERAD, X0 + 630, 260);
    DisplayVariable("Elevator trim", " %10.2f", IosLink_AeroPkt.ElevatorTrim * ONERAD, X0 + 10, 230);
    DisplayVariable("Aileron trim", " %10.2f", IosLink_AeroPkt.AileronTrim * ONERAD, X0 + 320, 230);
    DisplayVariable("Rudder trim", " %10.2f", IosLink_AeroPkt.RudderTrim * ONERAD, X0 + 630, 230);
