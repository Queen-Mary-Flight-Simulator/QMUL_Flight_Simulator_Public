...
set xr[0.0:100.000000]
set yr[-5.000000:20.000000]
plot 'ex1.dat' using 1:2 title 'PITCH' with lines
set origin 0, 0.600000
set ylabel "PITCH RATE DEG/S"
set xr[0.0:100.000000]
set yr[-10.000000:10.000000]
plot 'ex1.dat' using 1:3 title 'PITCH RATE' with lines
set origin 0, 0.400000
set ylabel "ALTITUDE FT"
set xr[0.0:100.000000]
set yr[2500.000000:3500.000000]
plot 'ex1.dat' using 1:4 title 'ALTITUDE' with lines
set origin 0, 0.200000
set ylabel "TAS KTS"
set xr[0.0:100.000000]
set yr[160.000000:240.000000]
plot 'ex1.dat' using 1:5 title 'TAS' with lines
set origin 0, 0.000000
set ylabel "ELEVATOR DEGS"
set xr[0.0:100.000000]
set yr[-20.000000:20.000000]
plot 'ex1.dat' using 1:6 title 'ELEVATOR' with lines
unset multiplot
reset
set output
