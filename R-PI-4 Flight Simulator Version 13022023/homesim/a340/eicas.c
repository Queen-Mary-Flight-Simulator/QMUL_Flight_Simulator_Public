...
void EICAS_EprGauge(int EprX, int EprY, unsigned int EngineNumber)
{
	...
	/* draw arc */
    Glib_DrawTexture(-78, -73, 163.0, 103.0, PFDTextures[0].tex_umin, PFDTextures[0].tex_vmin, PFDTextures[0].tex_umax, PFDTextures[0].tex_vmax, 1.0);
...
void InitialisePFDTextureCoords()
{
    ...
    PFDTextures[0].tex_vmax = (300.0 + 30.0) / 1000.0;
