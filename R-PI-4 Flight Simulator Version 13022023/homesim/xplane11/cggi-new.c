                        ...
                        char *		outDesc)
{
    ...
    TargetX = GetRef("sim/flightmodel/position/localX");
    TargetY = GetRef("sim/flightmodel/position/localY");
    TargetZ = GetRef("sim/flightmodel/position/localZ");
...
{
    XPLMDataRef r;
    r = XPLMFindDataRef("sim/operation/override/override_planepath");
    if (r == NULL)
    {
