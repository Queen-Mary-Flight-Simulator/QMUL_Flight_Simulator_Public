...
static void WrDigit(unsigned int n, int x, int y, boolean GreenFlag);
...
/* --------------------------------------------------------------- */
static void WrDigit(unsigned int n, int x, int y, boolean Flag)
{
  if (Flag) {
