...
void NavLink_FormPacket()
{
	...
	//printf("runqdm=%f runlat=%f runlong=%f\n",NavLink_NavPkt.RunwayQDM*(180/3.14159265),NavLink_NavPkt.RunwayLatitude*(180/3.14159265),NavLink_NavPkt.RunwayLongitude*(180/3.14159265));
