...
#define NFD_OFFSET_X      0
#define NFD_OFFSET_Y      0  /* was 50 */

#define NFD_NfdX          (386 + NFD_OFFSET_X)
#define NFD_NfdY          (680 + NFD_OFFSET_Y)
...
#define NFD_RadioY        (NFD_OFFSET_Y + 50)
#define NFD_FCUX          (NFD_OFFSET_X + 0)
#define NFD_FCUY          (NFD_OFFSET_Y + 50)
...
extern void NFD_NFDInit(NFD_PtrProc p);
