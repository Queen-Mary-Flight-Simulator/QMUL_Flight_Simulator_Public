...
float                       WindSpeed;
float                       WindDirection;
IosDefn_RestoreVectorRecord LastRestore;
bool                        Restored;
bool                        OldOctaveMode;
bool                        OldReplayMode;
unsigned int                CmdPtr;
...
char                        Filename[50];
char                        DTEDFilename[50];
bool                        AeroLink_Stopping;
float                       AirportOffset;
/*                                                         Heathrow    Gatwick Manchester   Toulouse   Cranfield   Hong Kong
                                                               EGLL,      EGKK,      EGCC,      LFBO,       EGTC,       VHHH  */
double                      AirportLatitudes[]  = {  0.0, 51.477500, 51.148056, 53.353889, 43.635000,  52.072222,  22.308889 };
double                      AirportLongitudes[] = {  0.0, -0.461389, -0.190278, -2.275000,  1.367778,  -0.616667, 113.914722 };
float                       AirportCorrection[] = {  0.0,     -0.75,       0.0,      12.5,       0.0,        0.0 };
...
void AeroLink_FormPacket()
{
	...
	printf("lataero=%f longaero=%f yawaero=%f\n", AeroLink_AeroPkt.Latitude*RAD2DEG, AeroLink_AeroPkt.Longitude*RAD2DEG, AeroLink_AeroPkt.Yaw*RAD2DEG);
...
void BEGIN_AeroLink()
{
	...
	IOLib_SetIOPkt(&AeroLink_IOPkt1);
}
