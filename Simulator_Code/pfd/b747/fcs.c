...
float FCS_HDG(float HdgRef)
{
    ...
    HdgRef = HdgRef + AeroLink_NavPkt.MagneticVariation;
...
void FCS_Autoland(float *Elevator, float *Aileron)
{
    ...
    {
//        Qdm = AeroLink_NavPkt.ILS1.RunwayQdm; /* Heading-hold uses deg magnetic */
        Qdm = AeroLink_NavPkt.ILS1.RunwayQdm; /* true heading */
