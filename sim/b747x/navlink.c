...
void NavLink_RespondToIos()
{
    ...
    for (;; )
    {
        switch (GetWord())
        {
            ...
            case IosDefn_SetCompassMode:
                Systems_Failures[19] = GetBoolean();
                break;

            case IosDefn_SetFDMode:
            ...
            case IosDefn_LoadFlightPlan:
                ...
                if (wpn <= Nav_NumberOfWayPoints)
                {
                    ...
                    Nav_WayPoints[wpn].WayPointLatitude  = GetReal();
                    Nav_WayPoints[wpn].WayPointLongitude = GetReal();
            ...
            case IosDefn_AutopilotAltitudeOn:
                FCU_ALT_Hold = GetBoolean();
                break;

            case IosDefn_AutopilotHeadingOn:
                FCU_HDG_Hold = GetBoolean();
                break;

            case IosDefn_AutopilotSpeedOn:
                FCU_SPD_Hold = GetBoolean();
                break;

            case IosDefn_AutopilotVSpeedOn:
                FCU_VS_Hold = GetBoolean();
                break;
...
void NavLink_FormPacket()
{
    ...
    if (Nav_CurrentRunway > 0)
    {
        ...
        NavLink_NavPkt.RunwayQDM       = (short unsigned int) NavLib_Runways[Nav_CurrentRunway].Qdm;
    }
    else
    {
    ...
    NavLink_NavPkt.NAV1.GroundSpeed      = Nav_VOR1.Gspeed;
    NavLink_NavPkt.NAV1.GroundDistance   = Nav_VOR1.GroundDistance;
    ...
    NavLink_NavPkt.NAV2.GroundSpeed      = Nav_VOR2.Gspeed;
    NavLink_NavPkt.NAV2.GroundDistance   = Nav_VOR2.GroundDistance;
    ...
    NavLink_NavPkt.ADF1.GroundSpeed      = Nav_ADF1.Gspeed;
    NavLink_NavPkt.ADF1.GroundDistance   = Nav_ADF1.GroundDistance;
    ...
    NavLink_NavPkt.ADF2.GroundSpeed      = Nav_ADF2.Gspeed;
    NavLink_NavPkt.ADF2.GroundDistance   = Nav_ADF2.GroundDistance;
    ...
    NavLink_NavPkt.ILS1.GroundSpeed      = Nav_ILS1.Gspeed;
    NavLink_NavPkt.ILS1.GroundDistance   = Nav_ILS1.GroundDistance;
    ...
    NavLink_NavPkt.WayPoint.GroundSpeed      = Nav_WayPoint.Gspeed;
    NavLink_NavPkt.WayPoint.GroundDistance   = Nav_WayPoint.GroundDistance;
    ...
    NavLink_NavPkt.FCU_BaroSTD      = FCU_BaroSTD;
    NavLink_NavPkt.FCU_HDG_Hold     = FCU_HDG_Hold;
    NavLink_NavPkt.FCU_ALT_Hold     = FCU_ALT_Hold;
    NavLink_NavPkt.FCU_SPD_Hold     = FCU_SPD_Hold;
    NavLink_NavPkt.FCU_VS_Hold      = FCU_VS_Hold;
    NavLink_NavPkt.FCU_Metric_ALT   = FCU_Metric_Alt_Button;
...
void BEGIN_NavLink()
{
    ...
    NavLink_NavPkt.NAV1.GroundSpeed      = 0.0;
    NavLink_NavPkt.NAV1.GroundDistance   = 0.0;
    ...
    NavLink_NavPkt.NAV2.GroundSpeed      = 0.0;
    NavLink_NavPkt.NAV2.GroundDistance   = 0.0;
    ...
    NavLink_NavPkt.ADF1.GroundSpeed      = 0.0;
    NavLink_NavPkt.ADF1.GroundDistance   = 0.0;
    ...
    NavLink_NavPkt.ADF2.GroundSpeed      = 0.0;
    NavLink_NavPkt.ADF2.GroundDistance   = 0.0;
    ...
    NavLink_NavPkt.ILS1.GroundSpeed      = 0.0;
    NavLink_NavPkt.ILS1.GroundDistance   = 0.0;
    ...
    NavLink_NavPkt.WayPoint.GroundSpeed      = 0.0;
    NavLink_NavPkt.WayPoint.GroundDistance   = 0.0;
    ...
    NavLink_NavPkt.FCU_BaroSTD = false;
    NavLink_NavPkt.FCU_HDG_Hold = false;
    NavLink_NavPkt.FCU_ALT_Hold = false;
    NavLink_NavPkt.FCU_SPD_Hold = false;
    NavLink_NavPkt.FCU_VS_Hold = false;
