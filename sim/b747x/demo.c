...
static void SystemUpdate()
{
    ...
    Maths_Normalise(&Model_Yaw);
    Model_Pitch = Model_Pitch + dpitch;
    if (Model_Pitch < -0.3 || Model_Pitch > 0.3)
    {
        dpitch = -dpitch;
    }
    Model_Roll = Model_Roll + droll;
    if (Model_Roll < -1.0 || Model_Roll > 1.0)
    {
        droll = -droll;
    }
    ...
    AeroLink_NavPkt.NAV1.GroundSpeed = AeroLink_NavPkt.NAV1.GroundSpeed + dGroundSpeed;
    if (AeroLink_NavPkt.NAV1.GroundSpeed < 50.0 || AeroLink_NavPkt.NAV1.GroundSpeed > 100.0)
    {
        dGroundSpeed = -dGroundSpeed;
    }
...
int main(int argc, char *argv[])
{
    ...
    AeroLink_NavPkt.FCU_SPD_MACH = false;
    ...
    AeroLink_NavPkt.NAV1.GroundSpeed     = 75.0;
    dDmeDistance                         = 1.0;
    dGroundSpeed                         = 0.01;
    Model_R                              = 0.0;
    dSideForce                           = 1000.0;
