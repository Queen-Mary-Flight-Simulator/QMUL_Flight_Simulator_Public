...
#define Aero_ElevatorGain        (23.0 / Maths_ONERAD)
#define Aero_AileronGain         (40.0 / Maths_ONERAD)
#define Aero_RudderGain          (25.0 / Maths_ONERAD)
#define Aero_TillerGain          (75.0 / Maths_ONERAD)
#define Aero_ElevatorTrimGain    (20.0 / Maths_ONERAD)
#define Aero_AileronTrimGain     (40.0 / Maths_ONERAD)
#define Aero_RudderTrimGain      (25.0 / Maths_ONERAD)
